...
function getDomainLocale(path, locale, locales, domainLocales) {
    if (true) {
        const normalizeLocalePath = (__webpack_require__(1860).normalizeLocalePath);
        const detectDomainLocale = (__webpack_require__(3570).detectDomainLocale);
...
/* unused reexport */ __webpack_require__(6850)
